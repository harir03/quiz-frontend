...
### `src/services/API/RootClient.ts` - Backend Client

Creates an Axios instance configured with the backend URL from `VUE_APP_BACKEND`. All API service modules import the shared client from here.
...
|----------|-------------|---------|
| `VUE_APP_BACKEND` | Backend API URL | `http://127.0.0.1:8001` |
